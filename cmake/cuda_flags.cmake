...
target_compile_options(
    TNL_CUDA
    INTERFACE $<$<CUDA_COMPILER_ID:NVIDIA>:
...
target_compile_options(
    TNL_CUDA INTERFACE $<$<CUDA_COMPILER_ID:NVIDIA>: "SHELL:-Xcudafe --diag_suppress=esa_on_defaulted_function_ignored" >
)
# nvcc 10 causes many invalid VLA errors in the host code
target_compile_options(
    TNL_CUDA INTERFACE $<$<AND:$<CUDA_COMPILER_ID:NVIDIA>,$<VERSION_LESS:$<CUDA_COMPILER_VERSION>,11>>:
...
target_compile_options(
    TNL_CUDA
    INTERFACE $<$<CUDA_COMPILER_ID:Clang>:-fcolor-diagnostics> ;
