...
void
expect_seq( const Array& a, const Seq& seq )
{
...
TEST( SlicedNDArrayTest, Sliced2D_HalfStatic_Identity )
{
   constexpr int I = 3;
   const int J = 5;
   SlicedNDArray< int, SizesHolder< int, I, 0 >, index_sequence< 0, 1 >, SliceInfo< 1, 2 > > a;  // J is sliced
   a.setSizes( 0, J );
...
TEST( SlicedNDArrayTest, Sliced2D_HalfStatic_Permuted )
{
   const int I = 3;
   constexpr int J = 5;
   SlicedNDArray< int, SizesHolder< int, 0, J >, index_sequence< 1, 0 >, SliceInfo< 0, 2 > > a;  // I is sliced
   a.setSizes( I, 0 );
