...
{
   constexpr int I = 3, J = 5;
   NDArray< int, SizesHolder< int, I, J >, index_sequence< 1, 0 > > a;
   a.setSizes( 0, 0 );
...
TEST( NDArrayTest, CopySemanticsCrossDevice )
{
   constexpr int I = 3, J = 4;
   NDArray< int, SizesHolder< int, 0, 0 > > a;
   NDArray< int, SizesHolder< int, 0, 0 >, std::index_sequence< 0, 1 >, TNL::Devices::Cuda > da;
   a.setSizes( I, J );
   da.setSizes( I, J );
...
{
   int I = 2;
   NDArray< int, SizesHolder< int, 0 >, index_sequence< 0 > > a;
   a.setSizes( I );
   a.setValue( 0 );
...
{
   int I = 2, J = 3;
   NDArray< int, SizesHolder< int, 0, 0 >, index_sequence< 1, 0 > > a;
   a.setSizes( I, J );
   a.setValue( 0 );
...
{
   int I = 2, J = 3, K = 4;
   NDArray< int, SizesHolder< int, 0, 0, 0 >, index_sequence< 2, 0, 1 > > a;
   a.setSizes( I, J, K );
   a.setValue( 0 );
...
{
   int I = 2, J = 3, K = 4, L = 5;
   NDArray< int, SizesHolder< int, 0, 0, 0, 0 >, index_sequence< 3, 2, 0, 1 > > a;
   a.setSizes( I, J, K, L );
   a.setValue( 0 );
...
TEST( NDArrayTest, forAll_dynamic_5D )
{
   ...
   NDArray< int, SizesHolder< int, 0, 0, 0, 0, 0 >, index_sequence< 3, 4, 2, 0, 1 > > a;
   ...
   for( int j = 0; j < J; j++ )
      for( int i = 0; i < I; i++ ) {
         if( i == 0 || i == I - 1 || j == 0 || j == J - 1 )
            EXPECT_EQ( a( i, j ), 0 ) << "i = " << i << ", j = " << j;
         else
            EXPECT_EQ( a( i, j ), 1 ) << "i = " << i << ", j = " << j;
      }
}
      ...
      for( int i = 0; i < I; i++ )
         for( int j = 0; j < J; j++ ) {
            if( i == 0 || i == I - 1 || j == 0 || j == J - 1 || k == 0 || k == K - 1 )
               EXPECT_EQ( a( i, j, k ), 0 ) << "i = " << i << ", j = " << j << ", k = " << k;
            else
               EXPECT_EQ( a( i, j, k ), 1 ) << "i = " << i << ", j = " << j << ", k = " << k;
         }
}
...
TEST( NDArrayTest, forInterior_dynamic_4D )
{
   ...
   for( int l = 0; l < L; l++ )
      for( int k = 0; k < K; k++ )
         for( int i = 0; i < I; i++ )
            for( int j = 0; j < J; j++ ) {
               if( i == 0 || i == I - 1 || j == 0 || j == J - 1 || k == 0 || k == K - 1 || l == 0 || l == L - 1 )
                  EXPECT_EQ( a( i, j, k, l ), 0 ) << "i = " << i << ", j = " << j << ", k = " << k << ", l = " << l;
               else
                  EXPECT_EQ( a( i, j, k, l ), 1 ) << "i = " << i << ", j = " << j << ", k = " << k << ", l = " << l;
            }
}
...
{
   int I = 3, J = 3, K = 3;
   NDArray< int, SizesHolder< int, 0, 0, 0 >, index_sequence< 0, 1, 2 > > a;
   a.setSizes( I, J, K );
   a.setValue( 0 );
