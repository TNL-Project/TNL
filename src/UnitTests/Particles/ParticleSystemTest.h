...
template< typename Device >
void
particlesSystemAssignment()
{
   using ParticlesSetup = Particles2DSetup< Device >;
   using Particles = TNL::ParticleSystem::ParticlesLinkedList< typename ParticlesSetup::ParticlesConfig, Device >;
...
{
   using DeviceHost = TNL::Devices::Host;
   particlesSystemAssignment< DeviceHost >();
}

#if defined( __CUDACC__ ) || defined( __HIP__ )
TEST( SearchForNeighbors2DTest, ParticlesPropertiesCuda )
{
   using DeviceCuda = TNL::Devices::Cuda;
   particlesSystemAssignment< DeviceCuda >();
}
#endif

template< typename Device >
void
particlesCellIndices()
{
   using ParticlesSetup = Particles2DSetup< Device >;
   using Particles = TNL::ParticleSystem::ParticlesLinkedList< typename ParticlesSetup::ParticlesConfig, Device >;
   using ParticlesPointer = typename Pointers::SharedPointer< Particles, Device >;
...
TEST( SearchForNeighbors2DTest, ComputeParticleCellIndicesHost )
{
   using Device = TNL::Devices::Host;
   particlesCellIndices< Device >();
}
...
TEST( SearchForNeighbors2DTest, SortParticlesHost )
{
   using Device = TNL::Devices::Host;
   particlesSort< Device >();
}
...
TEST( SearchForNeighbors2DTest, ParticlesToCellsHost )
{
   using Device = TNL::Devices::Host;
   particlesToCells< Device >();
}
