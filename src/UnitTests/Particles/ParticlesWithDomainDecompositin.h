...
{
   using Config = ParticlesWithDecomposition2DConfig;
...
template< typename Device >
void
decomposedParticleSystemAssignment()
{
   using Setup = ParticlesWithDecomposition2DSetup< Device >;
   using Particles = TNL::ParticleSystem::ParticlesLinkedList< typename Setup::Config, Device >;
...
TEST( ParticlesWithDecomposition2DTest, ParticlesPropertiesHost )
{
   ...
   decomposedParticleSystemAssignment< Device >();
}

#if defined( __CUDACC__ ) || defined( __HIP__ )
TEST( ParticlesWithDecomposition2DTest, ParticlesPropertiesCuda )
{
...
template< typename Device >
void
decomposedParticleComputeCellIndices()
{
   using Setup = ParticlesWithDecomposition2DSetup< Device >;
   using Particles = TNL::ParticleSystem::ParticlesLinkedList< typename Setup::Config, Device >;
   using ParticlesPointer = typename Pointers::SharedPointer< Particles, Device >;
...
TEST( ParticlesWithDecomposition2DTest, ComputeParticleCellIndicesHost )
{
   using Device = TNL::Devices::Host;
   decomposedParticleComputeCellIndices< Device >();
}
