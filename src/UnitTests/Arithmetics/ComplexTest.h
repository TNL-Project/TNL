...
TYPED_TEST( ComplexTest, comparisonOperatorWithReal )
{
   ...
   for( int i = 0; i <= size; i++ ) {
      ...
      EXPECT_TRUE( TNL::cos( phase_i ) == ci );
      EXPECT_TRUE( TNL::cos( phase_i ) != cj );
   }
}
...
TYPED_TEST( ComplexTest, addOperatorWithReal2 )
{
   using ComplexType = typename TestFixture::ComplexType;
   using RealType = typename ComplexType::ValueType;
...
TYPED_TEST( ComplexTest, subtractOperatorWithReal2 )
{
   using ComplexType = typename TestFixture::ComplexType;
   using RealType = typename ComplexType::ValueType;
...
TYPED_TEST( ComplexTest, multiplyOperatorWithReal2 )
{
   using ComplexType = typename TestFixture::ComplexType;
   using RealType = typename ComplexType::ValueType;
...
TYPED_TEST( ComplexTest, divideOperatorWithReal2 )
{
   using ComplexType = typename TestFixture::ComplexType;
   using RealType = typename ComplexType::ValueType;
