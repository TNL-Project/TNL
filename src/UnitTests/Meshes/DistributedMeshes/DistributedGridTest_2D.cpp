...
void
setDof_2D( DofType& dof, typename DofType::RealType value )
{
...
template< typename DofType, typename GridType >
void
check_Boundary_2D( int rank, const GridType& grid, const DofType& dof, typename DofType::RealType expectedValue )
{
   if( rank == 0 )  //Up Left
   {
...
template< typename DofType, typename GridType >
void
check_Overlap_2D( int rank, const GridType& grid, const DofType& dof, typename DofType::RealType expectedValue )
{
   if( rank == 0 )  //Up Left
   {
      checkRightEdge( grid, dof, false, true, expectedValue );
