...
void
setDof_3D( DofType& dof, typename DofType::RealType value )
{
...
void
checkConner( const GridType& grid,
             const DofType& dof,
             bool bottom,
             bool north,
             bool west,
...
template< typename DofType, typename GridType >
void
checkXDirectionEdge( const GridType& grid,
                     const DofType& dof,
                     bool bottom,
                     bool north,
                     typename DofType::RealType expectedValue )
...
template< typename DofType, typename GridType >
void
checkYDirectionEdge( const GridType& grid,
                     const DofType& dof,
                     bool bottom,
                     bool west,
                     typename DofType::RealType expectedValue )
...
template< typename DofType, typename GridType >
void
check_Boundary_3D( int rank, const GridType& grid, const DofType& dof, typename DofType::RealType expectedValue )
{
...
template< typename DofType, typename GridType >
void
CheckConnerNode_Overlap( const GridType& grid,
                         const DofType& dof,
                         bool bottom,
                         bool north,
                         bool west,
...
template< typename DofType, typename GridType >
void
CheckXEdgeNode_Overlap( const GridType& grid,
                        const DofType& dof,
                        bool bottom,
                        bool north,
                        typename DofType::RealType expectedValue )
...
template< typename DofType, typename GridType >
void
CheckYEdgeNode_Overlap( const GridType& grid,
                        const DofType& dof,
                        bool bottom,
                        bool west,
                        typename DofType::RealType expectedValue )
...
template< typename DofType, typename GridType >
void
CheckZEdgeNode_Overlap( const GridType& grid,
                        const DofType& dof,
                        bool north,
                        bool west,
                        typename DofType::RealType expectedValue )
...
template< typename DofType, typename GridType >
void
CheckXFaceNode_Overlap( const GridType& grid, const DofType& dof, bool west, typename DofType::RealType expectedValue )
{
...
template< typename DofType, typename GridType >
void
CheckYFaceNode_Overlap( const GridType& grid, const DofType& dof, bool north, typename DofType::RealType expectedValue )
{
...
template< typename DofType, typename GridType >
void
CheckZFaceNode_Overlap( const GridType& grid, const DofType& dof, bool bottom, typename DofType::RealType expectedValue )
{
...
template< typename DofType, typename GridType >
void
CheckCentralNode_Overlap( const GridType& grid, const DofType& dof, typename DofType::RealType expectedValue )
{
   checkConner( grid, dof, false, false, false, expectedValue );
   checkConner( grid, dof, false, false, true, expectedValue );
   checkConner( grid, dof, false, true, false, expectedValue );
...
template< typename DofType, typename GridType >
void
check_Overlap_3D( int rank, const GridType& grid, const DofType& dof, typename DofType::RealType expectedValue )
{
   if( rank == 0 )
