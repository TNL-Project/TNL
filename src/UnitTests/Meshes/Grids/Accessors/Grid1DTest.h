...
using Implementations = ::testing::Types<
   TNL::Meshes::NDGrid<1, double, TNL::Devices::Host, int>,
   TNL::Meshes::NDGrid<1, float, TNL::Devices::Host, int>,
   TNL::Meshes::NDGrid<1, double, TNL::Devices::Cuda, int>,
   TNL::Meshes::NDGrid<1, float, TNL::Devices::Cuda, int>,
