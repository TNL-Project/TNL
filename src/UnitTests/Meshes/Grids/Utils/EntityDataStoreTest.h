...
void
testTraverse( const Grid& grid, DataStore& dataStore, int entitiesCount )
{
   ...
   TNL::Meshes::Templates::ForEachOrientation< Index, GridEntity::getEntityDimension(), Grid::getMeshDimension() >::exec(
      exec );
}
