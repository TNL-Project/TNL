...
protected:
   ...
   std::vector< typename GridType::CoordinatesType > dimensions = { { 1, 1 },
                                                                    { 2, 1 },
                                                                    { 1, 2 },
                                                                    { 2, 2 },
                                                                    { 3, 3 },
   ...
   std::vector< typename GridType::PointType > origins = { { 1, 1 },   { -10, -10 }, { 0.1, 0.1 },
                                                           { 1, 0.2 }, { 1, -1 },    { -2, -2 } };

   std::vector< typename GridType::PointType > spaceSteps = { { 0.1, 0.1 }, { 2, 2.4 }, { 0.1, 3.1 }, { 1, 4 }, { 12, 2 } };
