...
#ifdef __CUDACC__
using Implementations = ::testing::Types< TNL::Meshes::Grid< 3, double, TNL::Devices::Host, int >,
...
protected:
   ...
   std::vector< typename GridType::PointType > origins = { { 1, 1, 1 },   { -10, -10, 2 }, { 0.1, 0.1, 0.1 },
                                                           { 1, 0.2, 1 }, { 1, -1, 2 },    { -2, -2, -2 } };

   std::vector< typename GridType::PointType > spaceSteps = { { 0.1, 0.1, 0.1 },
                                                              { 2, 2.4, 2 },
                                                              { 0.1, 3.1, 1 },
                                                              { 1, 4, 2 },
                                                              { 12, 2, 1 } };
