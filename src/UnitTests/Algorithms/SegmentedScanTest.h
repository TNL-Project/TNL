...
TYPED_TEST( SegmentedScanTest, inclusive )
{
   ...
   v_view = 0;
   SegmentedScan< DeviceType >::perform(
      v_view, flags_view, 0, size, TNL::Plus{}, TNL::Plus::template getIdentity< ValueType >() );
   for( int i = 0; i < size; i++ )
