...
using BiEllpackSegmentsTypes = ::testing::Types<
   ...
   TNL::Algorithms::Segments::RowMajorBiEllpack< TNL::Devices::Host, int >,
...
INSTANTIATE_TYPED_TEST_SUITE_P( BiEllpackSegments, ReduceSegmentsTest, BiEllpackSegmentsTypes );
