...
TYPED_TEST( SortedBiEllpackReduceSegmentsTest, reduceSegments_MaximumInTriangularSegments )
{
...
TYPED_TEST( SortedBiEllpackReduceSegmentsTest, reduceSegmentsWithArgumentIf_MaximumInSegments )
{
