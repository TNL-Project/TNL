...
// Types for which SegmentsTest is instantiated - SortedSlicedEllpack segments
...
INSTANTIATE_TYPED_TEST_SUITE_P( SortedSlicedEllpackSegments, SegmentsTest, SortedSlicedEllpackSegmentsTypes );
