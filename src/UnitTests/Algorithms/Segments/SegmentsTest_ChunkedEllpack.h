...
TYPED_TEST( ChunkedEllpackSegmentsTest, reduceAllSegments_MaximumInSegments_short_fetch )
{
   using ChunkedEllpackSegmentsType = typename TestFixture::ChunkedEllpackSegmentsType;
...
TYPED_TEST( ChunkedEllpackSegmentsTest, reduceAllSegments_MaximumInSegmentsWithArgument )
{
   using ChunkedEllpackSegmentsType = typename TestFixture::ChunkedEllpackSegmentsType;
...
TYPED_TEST( ChunkedEllpackSegmentsTest, reduceAllSegments_MaximumInSegmentsWithSegmentIndexes )
{
   using ChunkedEllpackSegmentsType = typename TestFixture::ChunkedEllpackSegmentsType;
...
TYPED_TEST( ChunkedEllpackSegmentsTest, reduceAllSegmentsIf_MaximumInSegments )
{
   using ChunkedEllpackSegmentsType = typename TestFixture::ChunkedEllpackSegmentsType;
...
TYPED_TEST( ChunkedEllpackSegmentsTest, reduceAllSegmentsIfWithArgument_MaximumInSegments )
{
   using ChunkedEllpackSegmentsType = typename TestFixture::ChunkedEllpackSegmentsType;
