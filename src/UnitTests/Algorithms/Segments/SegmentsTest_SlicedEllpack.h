...
TYPED_TEST( SlicedEllpackSegmentsTest, forElements )
{
   using SlicedEllpackSegmentsType = typename TestFixture::SlicedEllpackSegmentsType;
...
TYPED_TEST( SlicedEllpackSegmentsTest, forElementsIf )
{
   using SlicedEllpackSegmentsType = typename TestFixture::SlicedEllpackSegmentsType;
...
TYPED_TEST( SlicedEllpackSegmentsTest, reduceAllSegments_MaximumInSegments_short_fetch )
{
   using SlicedEllpackSegmentsType = typename TestFixture::SlicedEllpackSegmentsType;
...
TYPED_TEST( SlicedEllpackSegmentsTest, reduceAllSegments_MaximumInSegmentsWithArgument )
{
   using SlicedEllpackSegmentsType = typename TestFixture::SlicedEllpackSegmentsType;
...
TYPED_TEST( SlicedEllpackSegmentsTest, reduceAllSegments_MaximumInSegmentsWithSegmentIndexes )
{
   using SlicedEllpackSegmentsType = typename TestFixture::SlicedEllpackSegmentsType;
...
TYPED_TEST( SlicedEllpackSegmentsTest, reduceSegmentsIf_MaximumInSegments )
{
   using SlicedEllpackSegmentsType = typename TestFixture::SlicedEllpackSegmentsType;
...
TYPED_TEST( SlicedEllpackSegmentsTest, reduceSegmentsIfWithArgument_MaximumInSegments )
{
   using SlicedEllpackSegmentsType = typename TestFixture::SlicedEllpackSegmentsType;
