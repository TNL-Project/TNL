...
TYPED_TEST( GraphTest, test_MST_large_3 )
{
   ...
   std::map< std::pair< IndexType, IndexType >, RealType > map{
      { { 3, 0 }, 10.0 },
      { { 4, 2 }, 7.0 },
      { { 5, 0 }, 5.0 },{ { 5, 1 }, 1.0 },{ { 5, 3 }, 3.0 },
      { { 6, 1 }, 6.0 },{ { 6, 2 }, 4.0 },{ { 6, 0 }, 4.0 },
      { { 7, 0 }, 4.0 },{ { 7, 2 }, 5.0 },{ { 7, 3 }, 10.0 },{ { 7, 4 }, 9.0 },
      { { 8, 5 }, 10.0 },
      { { 9, 7 }, 8.0 },
      { { 10, 5 }, 10.0 },{ { 10, 4 }, 9.0 },{ { 10, 7 }, 5.0 },{ { 10, 3 }, 2.0 },{ { 10, 2 }, 3.0 },{ { 10, 0 }, 8.0 },{ { 10, 1 }, 10.0 },{ { 10, 6 }, 7.0 },
      { { 11, 3 }, 4.0 },{ { 11, 5 }, 8.0 },{ { 11, 0 }, 1.0 },{ { 11, 6 }, 3.0 },{ { 11, 8 }, 4.0 },{ { 11, 2 }, 8.0 },{ { 11, 1 }, 9.0 },{ { 11, 4 }, 9.0 },
      { { 12, 7 }, 9.0 },{ { 12, 1 }, 5.0 },{ { 12, 2 }, 3.0 },{ { 12, 8 }, 1.0 },{ { 12, 6 }, 5.0 },{ { 12, 10 }, 2.0 },{ { 12, 3 }, 9.0 },{ { 12, 4 }, 2.0 },{ { 12, 5 }, 7.0 },
      { { 14, 5 }, 6.0 },{ { 14, 10 }, 3.0 },{ { 14, 4 }, 9.0 },{ { 14, 9 }, 8.0 },{ { 14, 3 }, 3.0 },{ { 14, 8 }, 3.0 },
      { { 16, 5 }, 10.0 },{ { 16, 12 }, 5.0 },
      { { 17, 11 }, 7.0 },{ { 17, 5 }, 9.0 },{ { 17, 13 }, 4.0 },{ { 17, 9 }, 3.0 },{ { 17, 15 }, 4.0 },
      { { 18, 16 }, 10.0 },{ { 18, 7 }, 7.0 },{ { 18, 13 }, 3.0 },{ { 18, 8 }, 9.0 },{ { 18, 6 }, 4.0 },{ { 18, 1 }, 9.0 },{ { 18, 12 }, 2.0 },{ { 18, 14 }, 2.0 },{ { 18, 11 }, 5.0 },{ { 18, 3 }, 1.0 },{ { 18, 2 }, 6.0 },
      { { 19, 10 }, 10.0 },{ { 19, 4 }, 1.0 },{ { 19, 8 }, 9.0 },{ { 19, 2 }, 3.0 },{ { 19, 7 }, 2.0 },{ { 19, 13 }, 1.0 },{ { 19, 16 }, 8.0 },{ { 19, 14 }, 10.0 },{ { 19, 1 }, 3.0 },
      { { 20, 12 }, 8.0 },{ { 20, 17 }, 5.0 },{ { 20, 0 }, 9.0 },{ { 20, 3 }, 3.0 },
      { { 22, 20 }, 9.0 },{ { 22, 2 }, 4.0 },{ { 22, 0 }, 3.0 },{ { 22, 9 }, 6.0 },{ { 22, 18 }, 9.0 },
      { { 23, 21 }, 3.0 },{ { 23, 19 }, 8.0 },{ { 23, 20 }, 9.0 },{ { 23, 1 }, 6.0 },{ { 23, 17 }, 1.0 },{ { 23, 4 }, 6.0 },{ { 23, 10 }, 2.0 },{ { 23, 16 }, 1.0 },{ { 23, 7 }, 10.0 },{ { 23, 18 }, 3.0 },{ { 23, 0 }, 5.0 },{ { 23, 14 }, 2.0 },{ { 23, 12 }, 5.0 },{ { 23, 6 }, 3.0 },{ { 23, 9 }, 9.0 },{ { 23, 15 }, 10.0 },
      { { 24, 16 }, 4.0 },{ { 24, 21 }, 8.0 },{ { 24, 5 }, 3.0 },{ { 24, 19 }, 8.0 },{ { 24, 20 }, 7.0 },{ { 24, 15 }, 6.0 },{ { 24, 3 }, 10.0 },{ { 24, 2 }, 10.0 },{ { 24, 7 }, 4.0 },
      { { 25, 3 }, 8.0 },{ { 25, 18 }, 1.0 },{ { 25, 4 }, 8.0 },{ { 25, 13 }, 5.0 },{ { 25, 1 }, 2.0 },{ { 25, 17 }, 10.0 },{ { 25, 15 }, 1.0 },{ { 25, 6 }, 3.0 },{ { 25, 5 }, 5.0 },{ { 25, 7 }, 9.0 },{ { 25, 11 }, 7.0 },{ { 25, 21 }, 10.0 },{ { 25, 10 }, 5.0 },{ { 25, 22 }, 4.0 },{ { 25, 19 }, 7.0 },{ { 25, 8 }, 8.0 },{ { 25, 12 }, 4.0 },{ { 25, 23 }, 5.0 },{ { 25, 20 }, 1.0 },{ { 25, 14 }, 10.0 },{ { 25, 2 }, 6.0 },{ { 25, 0 }, 4.0 },
      { { 26, 8 }, 1.0 },{ { 26, 12 }, 5.0 },{ { 26, 21 }, 4.0 },
      { { 27, 12 }, 8.0 },{ { 27, 8 }, 4.0 },
   ...
   std::cout << "minimum tree sum = " << sum(  max( v1, 0 ) ) << std::endl;
   std::cout << "expected tree sum = " << sum(  max( v2, 0 ) ) << std::endl;
   TNL::Graphs::GraphWriter< GraphType >::writeEdgeList( "minimum_tree.lst", minimum_tree );
   TNL::Graphs::GraphWriter< GraphType >::writeEdgeList( "graph.lst", graph );
