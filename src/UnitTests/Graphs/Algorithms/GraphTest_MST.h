...
TYPED_TEST( GraphTest, test_MST_large_2 )
{
   ...
   GraphType graph( 10, { { 0, 1, 0.5 }, { 0, 2, 0.7 }, { 1, 3, 1.0 }, { 2, 4, 0.3 }, { 3, 4, 0.8 },
                          { 4, 5, 0.2 }, { 5, 6, 0.6 }, { 6, 7, 0.9 }, { 7, 8, 0.3 }, { 8, 9, 0.5 },
                          { 9, 0, 0.7 }, { 1, 5, 0.5 }, { 2, 6, 0.8 }, { 3, 7, 0.2 }, { 4, 8, 0.4 },
                          { 5, 9, 0.9 }, { 6, 2, 0.8 }, { 7, 3, 0.2 }, { 8, 1, 0.7 }, { 9, 4, 0.1 } } );
...
TYPED_TEST( GraphTest, test_MST_large_3 )
{
   ...
   const auto& v1 = minimum_tree.getAdjacencyMatrix().getValues();
   const auto& v2 = expected_tree.getAdjacencyMatrix().getValues();
   ASSERT_TRUE( TNL::Graphs::Algorithms::isForest( minimum_tree ) );  // node 29 is not connected
