...
// Types for which MatrixTraverseTest is instantiated - SparseMatrix with Ellpack
...
INSTANTIATE_TYPED_TEST_SUITE_P( SparseMatrixEllpack, MatrixTraverseTest, SparseMatrixEllpackTypes );
