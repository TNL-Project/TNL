...
// Types for which MatrixTraverseTest is instantiated - DenseMatrix
using DenseMatrixTypes = ::testing::Types<
...
INSTANTIATE_TYPED_TEST_SUITE_P( DenseMatrix, MatrixTraverseTest, DenseMatrixTypes );
