...
TYPED_TEST( MatrixTest, WrapMatrix )
{
   ...
   auto wrappedCSRMatrix = TNL::Matrices::wrapCSRMatrix< DeviceType >(
      rows, columns, csrMatrixRowPointers, csrMatrixValues, csrMatrixColumnIndexes );
   auto wrappedEllpackMatrix = TNL::Matrices::wrapEllpackMatrix< DeviceType, TNL::Algorithms::Segments::RowMajorOrder >(
      rows, columns, (IndexType) 2, ellpackMatrixValues, ellpackMatrixColumnIndexes );
