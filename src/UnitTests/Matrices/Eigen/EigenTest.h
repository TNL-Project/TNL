...
checkPowerIterationDense2D()
{
   ...
   auto [ eigenvalue, eigenvector, iterations ] =
      TNL::Matrices::Eigen::powerIteration< RealType, Device, MatrixType >( A, epsilon, initialVec, 10000 );
   ...
   auto [ eigenvalueRMO, eigenvectorRMO, iterationsRMO ] =
      TNL::Matrices::Eigen::powerIteration< RealType, Device, MatrixTypeRMO >( C, epsilon, initialVecRMO, 10000 );
...
checkShiftedPowerIterationDense2D()
{
   ...
   const RealType epsilon = 1e-8;
   auto [ eigenvalue, eigenvector, iterations ] =
      TNL::Matrices::Eigen::shiftedPowerIteration< RealType, Device, MatrixType >( A, epsilon, 2, initialVec, 10000 );
   EXPECT_NEAR( eigenvalue, 3, 1e-7 );
   for( int i = 0; i < eigenvector.getSize(); i++ ) {
      EXPECT_NEAR( eigenvector.getElement( i ), TNL::sqrt( 2.0 ) / 2.0, 1e-7 );
   }
   ...
   auto [ eigenvalueB, eigenvectorB, iterationsB ] =
      TNL::Matrices::Eigen::shiftedPowerIteration< RealType, Device, MatrixType >( B, epsilon, 2, initialVecB, 10000 );
   ...
   VectorType initialVecRMO = { 1.0, 2.0 };
   auto [ eigenvalueRMO, eigenvectorRMO, iterationsRMO ] =
      TNL::Matrices::Eigen::shiftedPowerIteration< RealType, Device, MatrixTypeRMO >( C, epsilon, 2, initialVecRMO, 10000 );
   EXPECT_NEAR( eigenvalueRMO, 3, 1e-7 );
   for( int i = 0; i < eigenvectorRMO.getSize(); i++ ) {
      EXPECT_NEAR( eigenvectorRMO.getElement( i ), TNL::sqrt( 2.0 ) / 2.0, 1e-7 );
   }
   ...
   VectorType initialVecRMOD = { 1.0, 2.0 };
   auto [ eigenvalueRMOD, eigenvectorRMOD, iterationsRMOD ] =
      TNL::Matrices::Eigen::shiftedPowerIteration< RealType, Device, MatrixTypeRMO >( D, epsilon, 2, initialVecRMOD, 10000 );
...
checkQRAlgorithmDense0D( const TNL::Matrices::Factorization::QR::FactorizationMethod& QRmethod )
{
   ...
   try {
      auto [ eigenvalue, eigenvector, iterations ] =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeCMO >( A, epsilon, QRmethod, 10 );
      ADD_FAILURE();
   }
   catch( const std::invalid_argument& e ) {
      EXPECT_STREQ( "Zero-sized matrices are not allowed", e.what() );
   ...
   try {
      auto [ eigenvalue, eigenvector, iterations ] =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeCMO >( B, epsilon, QRmethod, 10 );
      ADD_FAILURE();
   }
   catch( const std::invalid_argument& e ) {
      EXPECT_STREQ( "Zero-sized matrices are not allowed", e.what() );
   ...
   try {
      auto [ eigenvalue, eigenvector, iterations ] =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeRMO >( C, epsilon, QRmethod, 10 );
      ADD_FAILURE();
   }
   catch( const std::invalid_argument& e ) {
      EXPECT_STREQ( "Zero-sized matrices are not allowed", e.what() );
   ...
   try {
      auto [ eigenvalue, eigenvector, iterations ] =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeRMO >( D, epsilon, QRmethod, 10 );
      ADD_FAILURE();
   }
   catch( const std::invalid_argument& e ) {
      EXPECT_STREQ( "Zero-sized matrices are not allowed", e.what() );
...
checkQRAlgorithmExceptionSizeSquare( const TNL::Matrices::Factorization::QR::FactorizationMethod& QRmethod )
{
   ...
   try {
      auto [ eigenvalue, eigenvector, iterations ] =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeRMO >( B, epsilon, QRmethod, 10 );
      ADD_FAILURE();
   }
   catch( const std::invalid_argument& e ) {
      EXPECT_STREQ( "Power iteration is possible only for square matrices", e.what() );
...
checkQRAlgorithmDense1D( const TNL::Matrices::Factorization::QR::FactorizationMethod& QRmethod )
{
   ...
   RealType epsilon = 1e-8;
   auto [ eigenvalue, eigenvector, iterations ] =
      TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeCMO >( A, epsilon, QRmethod, 10000 );
   ...
   if( QRmethod == TNL::Matrices::Factorization::QR::FactorizationMethod::Givens ) {
      ...
      MatrixTypeRMO B = { { 1.0 } };
      std::tie( eigenvalue, eigenvector, iterations ) =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeRMO >( B, epsilon, QRmethod, 10000 );
      EXPECT_EQ( eigenvalue.getElement( 0, 0 ), 1 );
      EXPECT_EQ( eigenvector.getElement( 0, 0 ), 1 );
...
checkQRAlgorithmDense2D( const TNL::Matrices::Factorization::QR::FactorizationMethod& QRmethod )
{
   ...
   auto [ eigenvalues, eigenvector, iterations ] =
      TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixType >( A, epsilon, QRmethod, 10000 );
   ...
   auto [ eigenvaluesB, eigenvectorB, iterationsB ] =
      TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixType >( B, epsilon, QRmethod, 10000 );
   EXPECT_EQ( iterationsB, 0 );
   ...
   if( QRmethod == TNL::Matrices::Factorization::QR::FactorizationMethod::Givens ) {
      auto [ eigenvaluesRMO, eigenvectorRMO, iterationsRMO ] =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeRMO >( C, epsilon, QRmethod, 10000 );
   ...
   if( QRmethod == TNL::Matrices::Factorization::QR::FactorizationMethod::Givens ) {
      auto [ eigenvaluesRMO, eigenvectorSRMO, iterationsRMO ] =
         TNL::Matrices::Eigen::QRalgorithm< RealType, MatrixTypeRMO >( D, epsilon, QRmethod, 10000 );
