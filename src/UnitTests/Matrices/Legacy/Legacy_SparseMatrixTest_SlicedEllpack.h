...
using SlicedEllpackMatrixTypes = ::testing::Types< SlicedEllpackType< int, TNL::Devices::Host, int >,
...
//    std::cout << "\n    TODO: Finish implementation of getNonZeroRowLength (Only non-zero elements, not the number of
//    allocated elements.)\n\n";
//}
