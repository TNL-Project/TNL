...
// Types for which MatrixReduceTest is instantiated - SparseMatrix with CSR
...
INSTANTIATE_TYPED_TEST_SUITE_P( SparseMatrixCSR, MatrixReduceTest, SparseMatrixCSRTypes );
