...
// Types for which MatrixReduceTest is instantiated - SparseMatrix with ChunkedEllpack
...
INSTANTIATE_TYPED_TEST_SUITE_P( SparseMatrixChunkedEllpack, MatrixReduceTest, SparseMatrixChunkedEllpackTypes );
