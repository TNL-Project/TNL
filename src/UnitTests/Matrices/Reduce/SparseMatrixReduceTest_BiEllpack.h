...
// Types for which MatrixReduceTest is instantiated - SparseMatrix with BiEllpack
...
INSTANTIATE_TYPED_TEST_SUITE_P( SparseMatrixBiEllpack, MatrixReduceTest, SparseMatrixBiEllpackTypes );
