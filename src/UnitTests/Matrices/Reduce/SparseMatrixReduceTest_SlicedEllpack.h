...
// Types for which MatrixReduceTest is instantiated - SparseMatrix with SlicedEllpack
...
INSTANTIATE_TYPED_TEST_SUITE_P( SparseMatrixSlicedEllpack, MatrixReduceTest, SparseMatrixSlicedEllpackTypes );
