...
struct OriginalRungeKutta
{
   ...
   {
      constexpr std::array< Value, Stages > time_coefficients{ 0.0, 1.0 / 2.0, 1.0 / 2.0, 1.0 };
   ...
   {
      constexpr std::array< Value, Stages > update_coefficients{ 1.0 / 6.0, 1.0 / 3.0, 1.0 / 3.0, 1.0 / 6.0 };
