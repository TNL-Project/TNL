...
/**
 * \brief Second order [midpoint](https://en.wikipedia.org/wiki/List_of_Runge%E2%80%93Kutta_methods) method.
 *
...
protected:
   ...
   static constexpr std::array< Value, Stages > time_coefficients { 0.0, 1.0/2.0 };

   static constexpr std::array< Value, Stages > update_coefficients { 0.0, 1.0 };
   // clang-format on
};
