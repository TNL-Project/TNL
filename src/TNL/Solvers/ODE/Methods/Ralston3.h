...
/**
 * \brief Third order [Ralston's](https://en.wikipedia.org/wiki/List_of_Runge%E2%80%93Kutta_methods) method.
 *
...
protected:
   ...
   static constexpr std::array< std::array< Value, Stages>, Stages > k_coefficients {
      ...
      std::array< Value, Stages >{     0.0, 3.0/4.0, 0.0 }
   };

   static constexpr std::array< Value, Stages > time_coefficients { 0.0, 1.0/2.0, 3.0/4.0 };

   static constexpr std::array< Value, Stages > update_coefficients { 2.0/9.0, 1.0/3.0, 4.0/9.0 };
};
