      ...
      if( ! this->averaging ) {
         ...
         while( k < this->getMaxIterations() ) {
            ...
            if( restarting == PDLPRestarting::Fast ) {
               ...
               const RealType current_dual_objective = ( q, z_current.getView( n, N ) ) + ( filtered_l, maximum( lambda, 0 ) )
                                                     + ( filtered_u, minimum( lambda, 0 ) );
               ...
               const RealType averaged_dual_objective = ( q, z_averaged.getView( n, N ) ) + ( filtered_l, maximum( lambda, 0 ) )
                                                      + ( filtered_u, minimum( lambda, 0 ) );
