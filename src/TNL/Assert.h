...
// provide a useful error message for each supported compiler/platform
   ...
   /**
    * \brief Asserts that the expression `val` evaluates to `true`.
    *
    * The assertion succeeds if, and only if, `val` evaluates to `true`.
   ...
   /**
    * \brief Asserts that the expression `val` evaluates to `false`.
    *
    * The assertion succeeds if, and only if, `val` evaluates to `false`.
    * On success the test continues without any side effects.
    * On failure the test is terminated with the error message `msg`.
    */
   #define TNL_ASSERT_FALSE( val, msg )
   /**
    * \brief Asserts that the expression `val1` is equal to `val2`.
    *
    * The assertion succeeds if, and only if, `val1` and `val2` are equal.
    * On success the test continues without any side effects.
    * On failure the test is terminated with the error message `msg`.
    */
   #define TNL_ASSERT_EQ( val1, val2, msg )
   /**
    * \brief Asserts that the expression `val1` is not equal to `val2`.
    *
    * The assertion succeeds if, and only if, `val1` and `val2` are not equal.
    * On success the test continues without any side effects.
    * On failure the test is terminated with the error message `msg`.
    */
   #define TNL_ASSERT_NE( val1, val2, msg )
   /**
    * \brief Asserts that the expression `val1` is less than or equal to `val2`.
    *
    * The assertion succeeds if, and only if, `val1` is less than or equal to `val2`.
    * On success the test continues without any side effects.
    * On failure the test is terminated with the error message `msg`.
    */
   #define TNL_ASSERT_LE( val1, val2, msg )
   /**
    * \brief Asserts that the expression `val1` is less than `val2`.
    *
    * The assertion succeeds if, and only if, `val1` is less than `val2`.
    * On success the test continues without any side effects.
    * On failure the test is terminated with the error message `msg`.
    */
   #define TNL_ASSERT_LT( val1, val2, msg )
   /**
    * \brief Asserts that the expression `val1` is greater than or equal to `val2`.
    *
    * The assertion succeeds if, and only if, `val1` is greater than or equal to `val2`.
    * On success the test continues without any side effects.
    * On failure the test is terminated with the error message `msg`.
    */
   #define TNL_ASSERT_GE( val1, val2, msg )
   /**
    * \brief Asserts that the expression `val1` is greater than `val2`.
    *
    * The assertion succeeds if, and only if, `val1` is greater than `val2`.
    * On success the test continues without any side effects.
    * On failure the test is terminated with the error message `msg`.
    */
