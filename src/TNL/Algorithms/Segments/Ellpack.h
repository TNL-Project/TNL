...
template <typename Device, typename Index,
          ...
          ElementsOrganization Organization =
              Segments::DefaultElementsOrganization<Device>::getOrganization(),
          int Alignment = 32>
...
public:
  ...
  using OffsetsContainer =
      Containers::Vector<Index, Device, typename Base::IndexType,
                         IndexAllocator>;
   ...
   */
  template <typename SizesContainer> Ellpack(const SizesContainer &sizes);
  ...
  template <typename Device_, typename Index_, typename IndexAllocator_,
            ElementsOrganization Organization_, int Alignment_>
  Ellpack &operator=(const Ellpack<Device_, Index_, IndexAllocator_,
                                   Organization_, Alignment_> &segments);
  ...
  [[nodiscard]] ConstViewType getConstView() const;
...
template <typename Device, typename Index,
          typename IndexAllocator =
              typename Allocators::Default<Device>::template Allocator<Index>,
          int Alignment = 32>
struct RowMajorEllpack
    : public Ellpack<Device, Index, IndexAllocator, RowMajorOrder, Alignment> {
  using BaseType =
...
template <typename Device, typename Index,
          typename IndexAllocator =
              typename Allocators::Default<Device>::template Allocator<Index>,
          int Alignment = 32>
struct ColumnMajorEllpack : public Ellpack<Device, Index, IndexAllocator,
                                           ColumnMajorOrder, Alignment> {
  using BaseType =
      Ellpack<Device, Index, IndexAllocator, ColumnMajorOrder, Alignment>;
...
template <typename Segments> struct isEllpackSegments : std::false_type {};

template <typename Device, typename Index, typename IndexAllocator,
          ElementsOrganization Organization, int Alignment>
...
template <typename Device, typename Index, typename IndexAllocator,
          int Alignment>
struct isEllpackSegments<
    ColumnMajorEllpack<Device, Index, IndexAllocator, Alignment>>
    : std::true_type {};

template <typename Device, typename Index, int Alignment>
struct isEllpackSegments<ColumnMajorEllpackView<Device, Index, Alignment>>
    : std::true_type {};

template <typename Device, typename Index, typename IndexAllocator,
          int Alignment>
struct isEllpackSegments<
    RowMajorEllpack<Device, Index, IndexAllocator, Alignment>>
    : std::true_type {};
template <typename Device, typename Index, int Alignment>
struct isEllpackSegments<RowMajorEllpackView<Device, Index, Alignment>>
    : std::true_type {};
