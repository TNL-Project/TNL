...
public:
   ...
   //! \brief Returns the data layout for the biellpack format (it is always row-major order).
   ...
   //! \brief This function denotes that the biellpack format uses padding elements.
