...
inline void
Grid< 1, Real, Device, Index >::forAll( Func func, FuncArgs... args ) const
{
...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forAll( const CoordinatesType& from, const CoordinatesType& to, Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const CoordinatesType& coordinate,
                                        const CoordinatesType& basis,
                                        const Index orientation,
...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forBoundary( Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const CoordinatesType& coordinate,
                                        const CoordinatesType& basis,
                                        const Index orientation,
...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forBoundary( const CoordinatesType& from, const CoordinatesType& to, Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const CoordinatesType& coordinate,
                                        const CoordinatesType& basis,
                                        const Index orientation,
...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forInterior( Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const CoordinatesType& coordinate,
                                        const CoordinatesType& basis,
                                        const Index orientation,
...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forInterior( const CoordinatesType& from, const CoordinatesType& to, Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const CoordinatesType& coordinate,
                                        const CoordinatesType& basis,
                                        const Index orientation,
