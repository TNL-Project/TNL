...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forAll( const Coordinate& from, const Coordinate& to, Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const Coordinate& coordinate,
                                        const Coordinate& basis,
                                        const Index orientation,
...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forBoundary( const Coordinate& from, const Coordinate& to, Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const Coordinate& coordinate,
                                        const Coordinate& basis,
                                        const Index orientation,
...
template< int EntityDimension, typename Func, typename... FuncArgs >
inline void
Grid< 1, Real, Device, Index >::forInterior( const Coordinate& from, const Coordinate& to, Func func, FuncArgs... args ) const
{
   auto exec = [ = ] __cuda_callable__( const Coordinate& coordinate,
                                        const Coordinate& basis,
                                        const Index orientation,
