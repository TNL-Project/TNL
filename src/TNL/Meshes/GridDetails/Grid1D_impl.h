...
template <typename Real, typename Device, typename Index> Grid<1, Real, Device, Index>::Grid ()
{
...
__cuda_callable__ inline Index
...
template <typename Real, typename Device, typename Index>
template <typename Entity>
__cuda_callable__ inline Entity
Grid<1, Real, Device, Index>::getEntity (const Index &entityIndex) const
{
...
Grid<1, Real, Device, Index>::forAll (Func func, FuncArgs... args) const
{
   ...
   switch (EntityDimension)
      ...
      case 1:
         ...
         TNL::Algorithms::ParallelFor<Device>::exec (0, this->dimensions.x (), outer, *this,
                                                     args...);
         break;
      default:
         break;
...
Grid<1, Real, Device, Index>::forInterior (Func func, FuncArgs... args) const
{
   ...
   switch (EntityDimension)
      {
      case 0:
         TNL::Algorithms::ParallelFor<Device>::exec (1, this->dimensions.x (), outer, *this,
                                                     args...);
         break;
      case 1:
