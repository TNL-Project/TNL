...
public:
   ...
   void
   setDimensions( const Container< Dimension, Index >& dimensions );
   ...
   __cuda_callable__
   inline Index
   getEntitiesCount( const Index index ) const;
   /**
    * @brief - Returns count of entities of specific dimension
    */
    ...
    */
   void
   setDomain( const Point& origin, const Point& proportions );
   /**
    * @brief Set the Origin of the grid
    */
   void
   setOrigin( const Point& origin ) noexcept;
   /**
    * @brief Set the Origin of the grid
    */
    ...
    */
   void
   setSpaceSteps( const Point& steps ) noexcept;
   /**
   ...
   __cuda_callable__
   inline Real
   getSpaceStepsProducts( const Coordinate& powers ) const;
   /**
...
protected:
   ...
   template< int EntityDimension, typename Func, typename... FuncArgs >
   inline void
   traverseAll( const Coordinate& from, const Coordinate& to, Func func, FuncArgs... args ) const;
   ...
   template< int EntityDimension, typename Func, typename... FuncArgs >
   inline void
   traverseInterior( const Coordinate& from, const Coordinate& to, Func func, FuncArgs... args ) const;
   ...
   template< int EntityDimension, typename Func, typename... FuncArgs >
   inline void
   traverseBoundary( const Coordinate& from, const Coordinate& to, Func func, FuncArgs... args ) const;
};
}  // namespace Meshes
}  // namespace TNL
