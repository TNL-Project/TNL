        ...
        StaticVector vLower, StaticVector vUpper )
{
  if( std::is_same< Device, Devices::Cuda >::value )
  {
    ...
    int numBlocksY = Backend::getNumberOfBlocks( mesh.getDimensions().y(), cudaBlockSize );
    int numBlocksZ = Backend::getNumberOfBlocks( mesh.getDimensions().z(), cudaBlockSize );
