...
#include "EnergyBoundaryConditionBoilerModel.h"
...
class BoundaryConditionsBoilerModel
{
   public:
      ...
      typedef TNL::Operators::EnergyBoundaryConditionsBoilerModel< MeshType, FunctionType, RealType, IndexType > EnergyBoundaryConditionsType;
