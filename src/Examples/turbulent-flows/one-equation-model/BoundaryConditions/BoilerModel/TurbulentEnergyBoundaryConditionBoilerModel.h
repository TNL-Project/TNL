...
class TurbulentEnergyBoundaryConditionsBoilerModel
{
...
class TurbulentEnergyBoundaryConditionsBoilerModelBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsBoilerModel< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsBoilerModelBase< Function >,
                         ...
                         Index >
{
   ...
   typedef TurbulentEnergyBoundaryConditionsBoilerModel< MeshType, Function, Real, Index > ThisType;
   typedef TurbulentEnergyBoundaryConditionsBoilerModelBase< Function > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsBoilerModel< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsBoilerModelBase< Function >,
...
// throttle TurbulentEnergy
               {
                  return 2.0/3.0 * this->intensity * this->intensity * this->horizontalThrottleSpeed * this->horizontalThrottleSpeed;
               }
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsBoilerModel< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsBoilerModelBase< Function >,
...
template< typename Mesh,
          ...
          typename Real,
          typename Index >
std::ostream& operator << ( std::ostream& str, const TurbulentEnergyBoundaryConditionsBoilerModel< Mesh, Function, Real, Index >& bc )
{
