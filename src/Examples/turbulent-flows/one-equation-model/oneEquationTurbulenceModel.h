...
#include "DifferentialOperators/One-Equation-Turbulence-Model/Steger-Warming/StegerWarming.h"
#include "DifferentialOperators/One-Equation-Turbulence-Model/VanLeer/VanLeer.h"
#include "DifferentialOperators/One-Equation-Turbulence-Model/AUSM+/AUSMPlus.h"
#include "flowsRhs.h"
...
#include "DifferentialOperatorsRightHandSide/PrandtlKolmogorovRightHandSide/PrandtlKolmogorovOperatorRightHandSide.h"
...
template< typename ConfigTag >class oneEquationTurbulenceModelConfig
{
   public:
...
class oneEquationTurbulenceModelSetter
{
   public:
	  ...
	  typedef oneEquationTurbulenceModelOperatorRightHandSide< MeshType, Real, Index > OperatorRightHandSide;
	  ...
	  if( differentialOperatorType == "Lax-Friedrichs" )
	     ...
	     typedef LaxFridrichs< MeshType, OperatorRightHandSide, Real, Index > ApproximateOperator;
             ...
             if( boundaryConditionsType == "cavity" )
             {
               ...
               typedef oneEquationTurbulenceModelProblem< MeshType, BoundaryConditions, RightHandSide, CommunicatorType, ApproximateOperator > Problem;
...
{
   Solvers::Solver< oneEquationTurbulenceModelSetter, oneEquationTurbulenceModelConfig, BuildConfig > solver;
