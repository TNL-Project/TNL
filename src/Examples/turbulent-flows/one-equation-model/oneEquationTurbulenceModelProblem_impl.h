/***************************************************************************
                          oneEquationTurbulenceModelProblem_impl.h  -  description
                             -------------------
    begin                : Feb 13, 2017
...
String
oneEquationTurbulenceModelProblem< Mesh, BoundaryCondition, RightHandSide, Communicator, InviscidOperators >::
getType()
{
   return String( "oneEquationTurbulenceModelProblem< " ) + Mesh :: getType() + " >";
}
       ...
       const String& prefix )
{
   ...
   this->characteristicLength = parameters.getParameter< double >( "characteristic-length" );
   this->viscosityConstant = parameters.getParameter< double >( "viscosity-constant" );
   ...
   this->inviscidOperatorsPointer->setCharacteristicLength( this->characteristicLength );
   this->inviscidOperatorsPointer->setViscosityConstant( this->viscosityConstant );
...
template< typename Mesh,
          ...
          typename Communicator,
          typename InviscidOperators >
typename oneEquationTurbulenceModelProblem< Mesh, BoundaryCondition, RightHandSide, Communicator, InviscidOperators >::IndexType
oneEquationTurbulenceModelProblem< Mesh, BoundaryCondition, RightHandSide, Communicator, InviscidOperators >::
getDofs() const
{
   /****
                   ...
                   DofVectorPointer& _fu )
{
    ...
    physicalVariables.getTurbulentViscosity( this->conservativeVariables, this->turbulentEnergy, this->viscosityConstant, this->characteristicLength, this->turbulentViscosity );
                         ...
                         DofVectorPointer& dofs )
{
    ...
    this->boundaryConditionPointer->setSpeed(this->intensity);
    this->boundaryConditionPointer->setIntensity(this->cavitySpeed);
