/***************************************************************************
                          PrandtlKolmogorovEnergyOperatorRightHandSide.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class PrandtlKolmogorovEnergyRightHandSideBase
{
   public:
      ...
      PrandtlKolmogorovEnergyRightHandSideBase()
...
template< typename Mesh,
          typename Real = typename Mesh::RealType,
          typename Index = typename Mesh::IndexType >
class PrandtlKolmogorovEnergyRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovEnergyRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
   : public PrandtlKolmogorovEnergyRightHandSideBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:

      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef PrandtlKolmogorovEnergyRightHandSideBase< MeshType, Real, Index > BaseType;
...
// 1D_t_11_x
                ...
                +
                  2.0 / 3.0 * ( velocity_x_east * density_east * turbulentEnergy_east
                              - velocity_x_west * density_west * turbulentEnergy_west
                              ) * hxInverse / 2;
      }
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovEnergyRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
   : public PrandtlKolmogorovEnergyRightHandSideBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
// vt_22_y
                + ( 4.0 / 3.0 * ( velocity_y_north * velocity_y_center * turbulentViscosity_center - velocity_y_center * velocity_y_south * turbulentViscosity_south
                  ...
                  +
                    2.0 / 3.0 * ( velocity_y_north * density_north * turbulentEnergy_north
                                - velocity_y_south * density_south * turbulentEnergy_south
                                ) * hyInverse / 2
                  );
      }
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovEnergyRightHandSide< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
   : public PrandtlKolmogorovEnergyRightHandSideBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
// wt_33_z
                + ( 4.0 / 3.0 * ( velocity_z_up * velocity_z_center * turbulentViscosity_center - velocity_z_center * velocity_z_down * turbulentViscosity_down
                  ...
                  +
                    2.0 / 3.0 * ( velocity_z_up   * density_up   * turbulentEnergy_up
                                - velocity_z_down * density_down * turbulentEnergy_down  
                                ) * hzInverse / 2
                  );                  
      }
