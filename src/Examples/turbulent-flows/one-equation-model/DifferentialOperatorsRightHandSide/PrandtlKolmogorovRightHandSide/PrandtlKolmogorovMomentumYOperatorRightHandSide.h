/***************************************************************************
                          PrandtlKolmogorovMomentumYRightHandSide.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
#include "PrandtlKolmogorovMomentumBaseOperatorRightHandSide.h"
...
class PrandtlKolmogorovMomentumYRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovMomentumYRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
   : public PrandtlKolmogorovMomentumRightHandSideBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:

      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef PrandtlKolmogorovMomentumRightHandSideBase< MeshType, Real, Index > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovMomentumYRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
   : public PrandtlKolmogorovMomentumRightHandSideBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
// T_12_x
                ...
                +
// t_22_y
                  ( 4.0 / 3.0 * ( turbulentViscosity_north * velocity_y_north - ( turbulentViscosity_north + turbulentViscosity_center ) * velocity_y_center + turbulentViscosity_center * velocity_y_south
                                ) * hySquareInverse
                  - 2.0 / 3.0 * ( turbulentViscosity_north * ( velocity_x_northEast - velocity_x_northWest ) - turbulentViscosity_south * ( velocity_x_southEast - velocity_x_southWest )
                                ) * hxInverse * hyInverse / 4
                  +
                    2.0 / 3.0 * ( density_north * turbulentEnergy_north
                                - density_south * turbulentEnergy_south
                                ) * hyInverse / 2
                  )
// t_12_x
                + ( ( turbulentViscosity_east * (velocity_x_northEast - velocity_x_southEast ) - turbulentViscosity_west * (velocity_x_northWest - velocity_x_southWest )
                    ) * hxInverse * hyInverse / 4
                  + ( turbulentViscosity_east * velocity_y_east - ( turbulentViscosity_east + turbulentViscosity_center ) * velocity_y_center + turbulentViscosity_center * velocity_y_west
                    ) * hxSquareInverse
                  );
      }
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovMomentumYRightHandSide< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, Real, Index >
   : public PrandtlKolmogorovMomentumRightHandSideBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
// t_22_y
                + ( 4.0 / 3.0 * ( turbulentViscosity_north * velocity_y_north - ( turbulentViscosity_north + turbulentViscosity_center ) * velocity_y_center + turbulentViscosity_south * velocity_y_south
                                ) * hySquareInverse
                  - 2.0 / 3.0 * ( turbulentViscosity_north * ( velocity_x_northEast - velocity_x_northWest ) - turbulentViscosity_south * ( velocity_x_southEast - velocity_x_southWest)
                                ) * hxInverse * hyInverse / 4
                  - 2.0 / 3.0 * ( turbulentViscosity_north * ( velocity_z_upNorth - velocity_z_downNorth ) - turbulentViscosity_south * ( velocity_z_upSouth - velocity_z_downSouth )
                                ) * hyInverse * hzInverse / 4
                  +
                    2.0 / 3.0 * ( density_north * turbulentEnergy_north
                                - density_south * turbulentEnergy_south
...
// t_32_z
                + ( ( turbulentViscosity_up * ( velocity_z_upNorth - velocity_z_upSouth ) - turbulentViscosity_down * ( velocity_z_downNorth - velocity_z_downSouth )
                     ) * hyInverse * hzInverse / 4
                  + ( turbulentViscosity_up * velocity_y_up - ( turbulentViscosity_up + turbulentViscosity_center ) * velocity_y_center + turbulentViscosity_center * velocity_y_down
                    ) * hzSquareInverse
                  );
      }
