/***************************************************************************
                          PrandtlKolmogorovMomentumZRightHandSide.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
class PrandtlKolmogorovMomentumZRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovMomentumZRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovMomentumZRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlKolmogorovMomentumZRightHandSide< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, Real, Index >
                ...
                + ( 4.0 / 3.0 * ( velocity_z_up - 2 * velocity_z_center + velocity_z_down ) 
                  ...
                  +
                    2.0 / 3.0 * ( density_up   * turbulentEnergy_up
                                - density_down * turbulentEnergy_down  
                                ) * hzInverse / 2
                  );
      }
