/***************************************************************************
                          AUSMPlusMomentumZ.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
#include "AUSMPlusMomentumBase.h"
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusMomentumZ< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusMomentumBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:

      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef AUSMPlusMomentumBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
      ...
      {
         return String( "AUSMPlusMomentumZ< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusMomentumZ< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusMomentumBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusMomentumZ< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusMomentumBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return  hxInverse * ( 
               ...
               + hzInverse * ( 
                               ...
                               - this->MainMomentumFlux( density_center, density_up    , velocity_z_center, velocity_z_up    , pressure_center, pressure_up     )
                             )
               +
