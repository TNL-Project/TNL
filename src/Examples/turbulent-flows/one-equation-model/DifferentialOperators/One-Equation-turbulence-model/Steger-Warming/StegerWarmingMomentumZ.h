/***************************************************************************
                          StegerWarmingMomentumZ.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
#include "StegerWarmingMomentumBase.h"
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingMomentumZ< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public StegerWarmingMomentumBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:

      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef StegerWarmingMomentumBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
      ...
      {
         return String( "StegerWarmingMomentumZ< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingMomentumZ< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public StegerWarmingMomentumBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingMomentumZ< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public StegerWarmingMomentumBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return 0-hxInverse * ( 
                               ...
                               - this->positiveOtherMomentumFlux( density_west  , velocity_x_west  , velocity_z_west  , pressure_west   )
                               - this->negativeOtherMomentumFlux( density_center, velocity_x_center, velocity_z_center, pressure_center )
                               + this->negativeOtherMomentumFlux( density_east  , velocity_x_east  , velocity_z_east  , pressure_east   )
                             )
                -hyInverse * ( 
                                 this->positiveOtherMomentumFlux( density_center, velocity_y_center, velocity_z_center, pressure_center )
                               - this->positiveOtherMomentumFlux( density_south , velocity_y_south , velocity_z_south , pressure_south  )
                               - this->negativeOtherMomentumFlux( density_center, velocity_y_center, velocity_z_center, pressure_center )
                               + this->negativeOtherMomentumFlux( density_north , velocity_y_north , velocity_z_north , pressure_north  )
                             )
                -hzInverse * ( 
