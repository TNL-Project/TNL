/***************************************************************************
                          PrandtlMomentumXRightHandSide.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
class PrandtlMomentumXRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlMomentumXRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlMomentumXRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class PrandtlMomentumXRightHandSide< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, Real, Index >
