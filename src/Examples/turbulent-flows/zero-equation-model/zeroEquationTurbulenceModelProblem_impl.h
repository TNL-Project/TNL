/***************************************************************************
                          zeroEquationTurbulenceModelProblem_impl.h  -  description
                             -------------------
    begin                : Feb 13, 2017
...
String
zeroEquationTurbulenceModelProblem< Mesh, BoundaryCondition, RightHandSide, Communicator, InviscidOperators >::
getType()
{
   return String( "zeroEquationTurbulenceModelProblem< " ) + Mesh :: getType() + " >";
}
...
template< typename Mesh,
          ...
          typename Communicator,
          typename InviscidOperators >
typename zeroEquationTurbulenceModelProblem< Mesh, BoundaryCondition, RightHandSide, Communicator, InviscidOperators >::IndexType
zeroEquationTurbulenceModelProblem< Mesh, BoundaryCondition, RightHandSide, Communicator, InviscidOperators >::
getDofs() const
{
   /****
