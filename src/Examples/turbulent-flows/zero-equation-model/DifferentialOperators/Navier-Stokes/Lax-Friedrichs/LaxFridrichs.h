...
#include "Examples/turbulent-flows/zero-equation-model/DifferentialOperatorsRightHandSide/PrandtlRightHandSide/PrandtlOperatorRightHandSide.h"

namespace TNL {

template< typename Mesh,
	  typename OperatorRightHandSide = PrandtlOperatorRightHandSide < Mesh, typename Mesh::RealType, typename Mesh::IndexType >,
...
class LaxFridrichs
{
   public:
      ...
      typedef Pointers::SharedPointer< OperatorRightHandSide > OperatorRightHandSidePointer;
      ...
      const OperatorRightHandSidePointer& getOperatorRightHandSide() const
      {
         return this->operatorRightHandSidePointer;
      }
   ...
   protected:
      ...
      OperatorRightHandSidePointer operatorRightHandSidePointer;  
