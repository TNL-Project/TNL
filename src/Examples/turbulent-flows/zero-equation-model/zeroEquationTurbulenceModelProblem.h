/***************************************************************************
                          zeroEquationTurbulenceModelProblem.h  -  description
                             -------------------
    begin                : Feb 13, 2017
...
class zeroEquationTurbulenceModelProblem:
                      ...
                      typename InviscidOperators::IndexType >
{
   ...
   protected:
      ...
      RealType mixingLength;           
};

} // namespace TNL

#include "zeroEquationTurbulenceModelProblem_impl.h"
