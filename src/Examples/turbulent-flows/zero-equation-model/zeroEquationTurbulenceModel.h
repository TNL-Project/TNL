...
template< typename ConfigTag >class zeroEquationTurbulenceModelConfig
{
   public:
...
class zeroEquationTurbulenceModelSetter
{
   public:
	  ...
	  typedef PrandtlRightHandSide< MeshType, Real, Index > OperatorRightHandSide;
	  ...
	  if( differentialOperatorType == "Lax-Friedrichs" )
	     ...
	     typedef LaxFridrichs< MeshType, OperatorRightHandSide, Real, Index > ApproximateOperator;
             ...
             if( boundaryConditionsType == "cavity" )
             {
                ...
                typedef zeroEquationTurbulenceModelProblem< MeshType, BoundaryConditions, RightHandSide, CommunicatorType, ApproximateOperator > Problem;
...
{
   Solvers::Solver< zeroEquationTurbulenceModelSetter, zeroEquationTurbulenceModelConfig, BuildConfig > solver;
