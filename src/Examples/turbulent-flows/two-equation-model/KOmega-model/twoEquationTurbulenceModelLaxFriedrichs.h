...
#include "DifferentialOperatorsRightHandSide/KOmegaRightHandSide/KOmegaOperatorRightHandSide.h"
...
class twoEquationTurbulenceModelSetter
{
   public:
	  ...
	  typedef KOmegaOperatorRightHandSide< MeshType, Real, Index > OperatorRightHandSide;
