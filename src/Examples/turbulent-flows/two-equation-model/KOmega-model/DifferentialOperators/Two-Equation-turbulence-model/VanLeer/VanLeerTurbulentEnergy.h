/***************************************************************************
                          VanLeerTurbulentEnergy.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class VanLeerTurbulentEnergyBase
{
   public:
      ...
      {
         return String( "VanLeerTurbulentEnergy< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
	 ...
	 this->rightHandSide.setDisipation( disipation );
      ...
      {
         this->rightHandSide.setBetaStar( betaStar );
      }  
      ...
      RealType positiveTurbulentEnergyFlux( const RealType& density, const RealType& velocity, const RealType& pressure, const RealType& turbulentEnergy ) const
      {
         ...
         if ( machNumber <= -1.0 )
            ...
            return turbulentEnergy * speedOfSound / 4.0 * ( machNumber + 1.0 ) * ( machNumber + 1.0 );
        else 
      ...
      RealType negativeTurbulentEnergyFlux( const RealType& density, const RealType& velocity, const RealType& pressure, const RealType& turbulentEnergy ) const
      {
         ...
         if ( machNumber <= -1.0 )
            ...
            return - turbulentEnergy * speedOfSound / 4 * ( machNumber - 1.0 ) * ( machNumber - 1.0 );
        else 
            return 0.0;
      };
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class VanLeerTurbulentEnergy< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public VanLeerTurbulentEnergyBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef VanLeerTurbulentEnergyBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class VanLeerTurbulentEnergy< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public VanLeerTurbulentEnergyBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class VanLeerTurbulentEnergy< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public VanLeerTurbulentEnergyBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
