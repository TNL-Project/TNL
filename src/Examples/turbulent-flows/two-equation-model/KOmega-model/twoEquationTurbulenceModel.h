...
#include "DifferentialOperators/Two-Equation-Turbulence-Model/Lax-Friedrichs/LaxFridrichs.h"
#include "DifferentialOperators/Two-Equation-Turbulence-Model/Steger-Warming/StegerWarming.h"
#include "DifferentialOperators/Two-Equation-Turbulence-Model/VanLeer/VanLeer.h"
...
class twoEquationTurbulenceModelSetter
{
   public:
	  ...
	  typedef twoEquationTurbulenceModelOperatorRightHandSide< MeshType, Real, Index > OperatorRightHandSide;
