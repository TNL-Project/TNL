...
class CompressibleConservativeVariables
{
   public:
      ...
      : density( meshPointer ),
        ...
        energy( meshPointer ),
        turbulentEnergy( meshPointer ),
        disipation( meshPointer ){};
      ...
      void setMesh( const MeshPointer& meshPointer )
      {
         ...
         this->turbulentEnergy->setMesh( meshPointer );
                 ...
                 IndexType offset = 0 )
      {
         ...
         currentOffset += this->energy->getDofs( meshPointer );
         this->turbulentEnergy->bind( meshPointer, data, currentOffset );
         currentOffset += this->turbulentEnergy->getDofs( meshPointer );
         this->disipation->bind( meshPointer, data, currentOffset );
      }
      ...
      IndexType getDofs( const MeshPointer& meshPointer ) const
      {
         return this->density->getDofs( meshPointer ) + 
            ...
            this->turbulentEnergy->getDofs( meshPointer ) +
            this->disipation->getDofs( meshPointer );
      }
      ...
      __cuda_callable__
      MeshFunctionPointer& getTurbulentEnergy()
      {
         return this->turbulentEnergy;
      }
      
      __cuda_callable__
      const MeshFunctionPointer& getTurbulentEnergy() const
      {
         return this->turbulentEnergy;
      }
      
      void setTurbulentEnergy( MeshFunctionPointer& turbulentEnergy )
      {
         this->turbulentEnergy = turbulentEnergy;
      }
      
      __cuda_callable__
      MeshFunctionPointer& getDisipation()
      {
         return this->disipation;
      }
      
      __cuda_callable__
      const MeshFunctionPointer& getDisipation() const
      {
         return this->disipation;
      }
      
      void setDisipation( MeshFunctionPointer& disipation )
      {
