...
class DisipationBoundaryConditionsBoilerModel
{
...
class DisipationBoundaryConditionsBoilerModelBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsBoilerModel< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsBoilerModelBase< Function >,
                         ...
                         Index >
{
   ...
   typedef DisipationBoundaryConditionsBoilerModel< MeshType, Function, Real, Index > ThisType;
   typedef DisipationBoundaryConditionsBoilerModelBase< Function > BaseType;
                                   ...
                                   const EntityType& entity ) const
   {
      ...
      {
         this->turbulenceConstant = turbulenceConstant;
      }
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsBoilerModel< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsBoilerModelBase< Function >,
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsBoilerModel< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsBoilerModelBase< Function >,
...
template< typename Mesh,
          ...
          typename Real,
          typename Index >
std::ostream& operator << ( std::ostream& str, const DisipationBoundaryConditionsBoilerModel< Mesh, Function, Real, Index >& bc )
{
