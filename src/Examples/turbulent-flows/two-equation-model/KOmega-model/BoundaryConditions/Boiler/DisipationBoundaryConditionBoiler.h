...
class DisipationBoundaryConditionsBoiler
{
...
class DisipationBoundaryConditionsBoilerBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsBoiler< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsBoilerBase< Function >,
                         ...
                         Index >
{
   ...
   typedef DisipationBoundaryConditionsBoiler< MeshType, Function, Real, Index > ThisType;
   typedef DisipationBoundaryConditionsBoilerBase< Function > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsBoiler< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsBoilerBase< Function >,
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsBoiler< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsBoilerBase< Function >,
...
template< typename Mesh,
          ...
          typename Real,
          typename Index >
std::ostream& operator << ( std::ostream& str, const DisipationBoundaryConditionsBoiler< Mesh, Function, Real, Index >& bc )
{
