...
class TurbulentEnergyBoundaryConditionsBoiler
{
...
class TurbulentEnergyBoundaryConditionsBoilerBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsBoiler< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsBoilerBase< Function >,
                         ...
                         Index >
{
   ...
   typedef TurbulentEnergyBoundaryConditionsBoiler< MeshType, Function, Real, Index > ThisType;
   typedef TurbulentEnergyBoundaryConditionsBoilerBase< Function > BaseType;
                              ...
                              const RealType& time = 0 ) const
   {
      ...
      if( entity.getCoordinates().x() == 0 )
         return 2.0/3.0 * this->intensity * this->intensity * this->cavitySpeed * this->cavitySpeed;
      else
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsBoiler< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsBoilerBase< Function >,
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsBoiler< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsBoilerBase< Function >,
...
template< typename Mesh,
          ...
          typename Real,
          typename Index >
std::ostream& operator << ( std::ostream& str, const TurbulentEnergyBoundaryConditionsBoiler< Mesh, Function, Real, Index >& bc )
{
