/***************************************************************************
                          KOmegaMomentumZRightHandSide.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
class KOmegaMomentumZRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KOmegaMomentumZRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KOmegaMomentumZRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KOmegaMomentumZRightHandSide< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, Real, Index >
