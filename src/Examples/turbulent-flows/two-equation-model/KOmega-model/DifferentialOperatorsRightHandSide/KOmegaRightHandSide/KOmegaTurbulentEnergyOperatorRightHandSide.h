/***************************************************************************
                          KOmegaTurbulentEnergyOperatorRightHandSide.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class KOmegaTurbulentEnergyRightHandSideBase
{
   public:
...
template< typename Mesh,
          typename Real = typename Mesh::RealType,
          typename Index = typename Mesh::IndexType >
class KOmegaTurbulentEnergyRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KOmegaTurbulentEnergyRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
   : public KOmegaTurbulentEnergyRightHandSideBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef KOmegaTurbulentEnergyRightHandSideBase< MeshType, Real, Index > BaseType;
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return
                ...
                * ( velocity_x_east - velocity_x_west ) * hxInverse / 2
                -
                   this->betaStar * turbulentEnergy_center * disipation_center
                +
                  this->dynamicalViscosity
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KOmegaTurbulentEnergyRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
   : public KOmegaTurbulentEnergyRightHandSideBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KOmegaTurbulentEnergyRightHandSide< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
   : public KOmegaTurbulentEnergyRightHandSideBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
