       ...
       const String& prefix )
{
   ...
   this->viscosityConstant1 = parameters.getParameter< double >( "viscosity-constant-1" );
   this->viscosityConstant2 = parameters.getParameter< double >( "viscosity-constant-2" );
   ...
   this->inviscidOperatorsPointer->setViscosityConstant1( this->viscosityConstant1 );
   this->inviscidOperatorsPointer->setViscosityConstant2( this->viscosityConstant2 );
