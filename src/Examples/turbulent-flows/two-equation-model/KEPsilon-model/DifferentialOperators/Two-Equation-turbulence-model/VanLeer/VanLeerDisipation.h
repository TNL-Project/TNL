/***************************************************************************
                          VanLeerDisipation.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class VanLeerDisipationBase
{
   public:
      ...
      {
         return String( "VanLeerDisipation< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
      ...
      RealType positiveDisipationFlux( const RealType& density, const RealType& velocity, const RealType& pressure, const RealType& disipation ) const
      {
         ...
         if ( machNumber <= -1.0 )
            ...
            return disipation * speedOfSound / 4.0 * ( machNumber + 1.0 ) * ( machNumber + 1.0 );
        else 
      ...
      RealType negativeDisipationFlux( const RealType& density, const RealType& velocity, const RealType& pressure, const RealType& disipation ) const
      {
         ...
         if ( machNumber <= -1.0 )
            ...
            return - disipation * speedOfSound / 4 * ( machNumber - 1.0 ) * ( machNumber - 1.0 );
        else 
            return 0.0;
      };
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class VanLeerDisipation< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public VanLeerDisipationBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef VanLeerDisipationBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class VanLeerDisipation< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public VanLeerDisipationBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class VanLeerDisipation< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public VanLeerDisipationBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
