/***************************************************************************
                          AUSMPlusContinuity.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class AUSMPlusContinuityBase
{
   public:
      ...
      {
         return String( "AUSMPlusContinuity< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
      ...
      RealType DensityFlux( const RealType& LeftDensity,
                            ...
                            const RealType& RightPressure ) const
      {
         ...
         return BorderSpeedOfSound * ( MachBorderPlus * LeftDensity + MachBorderMinus * RightDensity );
      };
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusContinuity< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusContinuityBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef AUSMPlusContinuityBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusContinuity< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusContinuityBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusContinuity< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusContinuityBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
