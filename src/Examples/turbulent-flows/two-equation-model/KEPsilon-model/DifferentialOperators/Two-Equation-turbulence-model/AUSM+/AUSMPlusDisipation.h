   ...
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return  hxInverse * (
               ...
               + hyInverse * (
                                   this->DisipationFlux( density_south , density_center, velocity_y_south , velocity_y_center, pressure_south , pressure_center, u[ south  ], u[ center ] )
                                -  this->DisipationFlux( density_center, density_north , velocity_y_center, velocity_y_north , pressure_center, pressure_north , u[ center ], u[ north ]  )
                             )
               +
                 this->rightHandSide(u, entity, time); 
      }
   ...
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return  hxInverse * (
               ...
               + hzInverse * (
                                   this->DisipationFlux( density_down  , density_center, velocity_z_down  , velocity_z_center, pressure_down  , pressure_center, u[ down ]  , u[ center ])
                                -  this->DisipationFlux( density_center, density_up    , velocity_z_center, velocity_z_up    , pressure_center, pressure_up    , u[ center ], u[ up ]    )
                             )
               +
                 this->rightHandSide(u, entity, time);
