/***************************************************************************
                          AUSMPlusDisipation.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class AUSMPlusDisipationBase
{
   public:
      ...
      {
         return String( "AUSMPlusDisipation< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
      ...
      RealType DisipationFlux( const RealType& LeftDensity,
                                    ...
                                    const RealType& LeftDisipation,
                                    const RealType& RightDisipation ) const
      {
         ...
         return BorderSpeedOfSound * ( MachBorderPlus * LeftDisipation + MachBorderMinus * RightDisipation );
      };
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusDisipation< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusDisipationBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef AUSMPlusDisipationBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return  hxInverse * (
                                   this->DisipationFlux( density_west  , density_center, velocity_x_west  , velocity_x_center, pressure_west  , pressure_center, u[ west   ], u[ center ] )
                                -  this->DisipationFlux( density_center, density_east  , velocity_x_center, velocity_x_east  , pressure_center, pressure_east  , u[ center ], u[ east ]   )
                             )
               +
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusDisipation< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusDisipationBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return  hxInverse * (
               ...
               + hyInverse * (
                                   this->DisipationFlux( density_north , density_center, velocity_y_north , velocity_y_center, pressure_north , pressure_center, u[ north  ], u[ center ] )
                                -  this->DisipationFlux( density_center, density_south , velocity_y_center, velocity_y_south , pressure_center, pressure_south , u[ center ], u[ south ]  )
                             )
               +
                 this->rightHandSide(u, entity, time); 
      }
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusDisipation< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusDisipationBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return  hxInverse * (
               ...
               + hyInverse * (
                                   this->DisipationFlux( density_north , density_center, velocity_y_north , velocity_y_center, pressure_north , pressure_center, u[ north ] , u[ center ] )
                                -  this->TurbulrntEnergyFlux( density_center, density_south , velocity_y_center, velocity_y_south , pressure_center, pressure_south , u[ center ], u[ south ]  )
                             )
               + hzInverse * (
                                   this->DisipationFlux( density_up    , density_center, velocity_z_up    , velocity_z_center, pressure_up    , pressure_center, u[ up ]    , u[ center ])
                                -  this->DisipationFlux( density_center, density_down  , velocity_z_center, velocity_z_down  , pressure_center, pressure_down  , u[ center ], u[ down ]  )
                             )
               +
                 this->rightHandSide(u, entity, time);
