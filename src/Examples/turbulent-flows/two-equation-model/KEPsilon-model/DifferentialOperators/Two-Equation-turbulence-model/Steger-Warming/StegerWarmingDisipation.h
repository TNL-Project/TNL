/***************************************************************************
                          StegerWarmingDisipation.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class StegerWarmingDisipationBase
{
   public:
      ...
      {
         return String( "StegerWarmingDisipation< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
      ...
      {
         this->rightHandSide.setViscosityConstant1( viscosityConstant1 );
      }     
      
      void setViscosityConstant2( const RealType& viscosityConstant2 )
      {
         this->rightHandSide.setViscosityConstant2( viscosityConstant2 );
      }     
      
      void setSigmaEpsilon( const RealType& sigmaEpsilon )
      {
         this->rightHandSide.setSigmaEpsilon( sigmaEpsilon );
      }
      ...
      {
          this->rightHandSide.setDisipation( disipation );
      }

      RealType positiveDisipationFlux( const RealType& density, const RealType& velocity, const RealType& pressure, const RealType& disipation ) const
      {
         ...
         if ( machNumber <= -1.0 )
            ...
            return disipation * speedOfSound / ( 2 * this->gamma ) * ( machNumber + 1.0 );
        else if ( machNumber <= 1.0 )
            return disipation * speedOfSound / ( 2 * this->gamma ) * ( ( 2.0 * this->gamma - 1.0 ) * machNumber + 1.0 );
        else 
            return disipation * velocity;
      };

      RealType negativeDisipationFlux( const RealType& density, const RealType& velocity, const RealType& pressure, const RealType& disipation ) const
      {
         const RealType& speedOfSound = std::sqrt( this->gamma * pressure / density );
         const RealType& machNumber = velocity / speedOfSound;
         if ( machNumber <= -1.0 )
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingDisipation< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public StegerWarmingDisipationBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef StegerWarmingDisipationBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return -hxInverse * (
                                   this->positiveDisipationFlux( density_center, velocity_x_center, pressure_center, u[ center ] )
                                -  this->positiveDisipationFlux( density_west  , velocity_x_west  , pressure_west  , u[ west   ] )
                                -  this->negativeDisipationFlux( density_center, velocity_x_center, pressure_center, u[ center ] )
                                +  this->negativeDisipationFlux( density_east  , velocity_x_east  , pressure_east  , u[ east   ] )
                             )
               +
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingDisipation< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public StegerWarmingDisipationBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return -hxInverse * (
                ...
                -hyInverse * (
                                   this->positiveDisipationFlux( density_center, velocity_y_center, pressure_center, u[ center ] )
                                -  this->positiveDisipationFlux( density_south , velocity_y_south , pressure_south , u[ south  ] )
                                -  this->negativeDisipationFlux( density_center, velocity_y_center, pressure_center, u[ center ] )
                                +  this->negativeDisipationFlux( density_north , velocity_y_north , pressure_north , u[ north  ] )
                             )
               +
                 this->rightHandSide(u, entity, time); 
      }
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingDisipation< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public StegerWarmingDisipationBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return -hxInverse * (
                ...
                -hzInverse * (
                                   this->positiveDisipationFlux( density_center, velocity_z_center, pressure_center, u[ center ] )
                                -  this->positiveDisipationFlux( density_down  , velocity_z_down  , pressure_down  , u[ down   ] )
                                -  this->negativeDisipationFlux( density_center, velocity_z_center, pressure_center, u[ center ] )
                                +  this->negativeDisipationFlux( density_up    , velocity_z_up    , pressure_up    , u[ up     ] )
                             )
               +
                 this->rightHandSide(u, entity, time);
