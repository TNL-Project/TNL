/***************************************************************************
                          KEpsilonTurbulentEnergyOperatorRightHandSide.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class KEpsilonTurbulentEnergyRightHandSideBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonTurbulentEnergyRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
   : public KEpsilonTurbulentEnergyRightHandSideBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef KEpsilonTurbulentEnergyRightHandSideBase< MeshType, Real, Index > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonTurbulentEnergyRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
   : public KEpsilonTurbulentEnergyRightHandSideBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonTurbulentEnergyRightHandSide< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
   : public KEpsilonTurbulentEnergyRightHandSideBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
