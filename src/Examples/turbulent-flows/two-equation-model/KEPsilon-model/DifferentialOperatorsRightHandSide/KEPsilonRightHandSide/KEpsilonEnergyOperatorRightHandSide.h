/***************************************************************************
                          KEpsilonEnergyOperatorRightHandSide.h  -  description
                             -------------------
    begin                : Feb 17, 2017
...
class KEpsilonEnergyRightHandSideBase
{
   public:
      ...
      KEpsilonEnergyRightHandSideBase()
...
template< typename Mesh,
          typename Real = typename Mesh::RealType,
          typename Index = typename Mesh::IndexType >
class KEpsilonEnergyRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonEnergyRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
   : public KEpsilonEnergyRightHandSideBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:

      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef KEpsilonEnergyRightHandSideBase< MeshType, Real, Index > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonEnergyRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
   : public KEpsilonEnergyRightHandSideBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonEnergyRightHandSide< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
   : public KEpsilonEnergyRightHandSideBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
