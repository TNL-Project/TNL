/***************************************************************************
                          KEpsilonMomentumZRightHandSide.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
class KEpsilonMomentumZRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonMomentumZRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonMomentumZRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class KEpsilonMomentumZRightHandSide< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, Real, Index >
