...
class DisipationBoundaryConditionsCavity
{
...
class DisipationBoundaryConditionsCavityBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsCavity< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsCavityBase< Function >,
                         ...
                         Index >
{
   ...
   typedef DisipationBoundaryConditionsCavity< MeshType, Function, Real, Index > ThisType;
   typedef DisipationBoundaryConditionsCavityBase< Function > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsCavity< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsCavityBase< Function >,
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class DisipationBoundaryConditionsCavity< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public DisipationBoundaryConditionsCavityBase< Function >,
...
template< typename Mesh,
          ...
          typename Real,
          typename Index >
std::ostream& operator << ( std::ostream& str, const DisipationBoundaryConditionsCavity< Mesh, Function, Real, Index >& bc )
{
