...
class TurbulentEnergyBoundaryConditionsCavity
{
...
class TurbulentEnergyBoundaryConditionsCavityBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsCavity< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsCavityBase< Function >,
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsCavity< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsCavityBase< Function >,
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class TurbulentEnergyBoundaryConditionsCavity< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public TurbulentEnergyBoundaryConditionsCavityBase< Function >,
...
template< typename Mesh,
          ...
          typename Real,
          typename Index >
std::ostream& operator << ( std::ostream& str, const TurbulentEnergyBoundaryConditionsCavity< Mesh, Function, Real, Index >& bc )
{
