...
#include "DisipationBoundaryConditionCavity.h"
...
class BoundaryConditionsCavity
{
   public:
      ...
      typedef TNL::Operators::DisipationBoundaryConditionsCavity< MeshType, FunctionType, RealType, IndexType > DisipationBoundaryConditionsType;
                  ...
                  const String& prefix = "" )
      {
         ...
         this->disipationBoundaryConditionsPointer->setup( meshPointer, parameters, prefix);
         return true;
      }
