...
main( int argc, char* argv[] )
{
   ...
   using IndexType = int;
   using MatrixType =
      TNL::Matrices::SparseMatrix< ValueType, DeviceType, IndexType, TNL::Matrices::GeneralMatrix, EllpackSegments >;
   ...
   // Convert to Ginkgo Csr matrix
   auto gko_A = gko::share( TNL::Matrices::getGinkgoMatrixCsr( exec, A ) );
