/***************************************************************************
                          NavierStokesMomentumYRightHandSide.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
class NavierStokesMomentumYRightHandSide
{
};
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class NavierStokesMomentumYRightHandSide< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class NavierStokesMomentumYRightHandSide< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class NavierStokesMomentumYRightHandSide< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, Real, Index >
