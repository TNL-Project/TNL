...
class MomentumXBoundaryConditionsBoilerModel
{
...
class MomentumXBoundaryConditionsBoilerModelBase
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class MomentumXBoundaryConditionsBoilerModel< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public MomentumXBoundaryConditionsBoilerModelBase< Function >,
                         ...
                         Index >
{
   ...
   typedef MomentumXBoundaryConditionsBoilerModel< MeshType, Function, Real, Index > ThisType;
   typedef MomentumXBoundaryConditionsBoilerModelBase< Function > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class MomentumXBoundaryConditionsBoilerModel< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public MomentumXBoundaryConditionsBoilerModelBase< Function >,
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class MomentumXBoundaryConditionsBoilerModel< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Function, Real, Index >
   : public MomentumXBoundaryConditionsBoilerModelBase< Function >,
...
template< typename Mesh,
          ...
          typename Real,
          typename Index >
std::ostream& operator << ( std::ostream& str, const MomentumXBoundaryConditionsBoilerModel< Mesh, Function, Real, Index >& bc )
{
