/***************************************************************************
                          AUSMPlusMomentumY.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusMomentumY< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusMomentumBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
      ...
      {
         return String( "AUSMPlusMomentumY< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusMomentumY< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusMomentumY< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
