...
class AUSMPlusEnergyBase
{
   public:
	 ...
	 this->rightHandSide.setDynamicalViscosity(dynamicalViscosity);
      ...
      RealType EnergyFlux( const RealType& LeftDensity,
                           ...
                           const RealType& LeftEnergy,
                           const RealType& RightEnergy ) const
      {
         ...
         return BorderSpeedOfSound * ( MachBorderPlus * ( LeftEnergy + LeftPressure) + MachBorderMinus * ( RightEnergy + RightPressure ) );
      };
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusEnergy< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusEnergyBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:

      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef AUSMPlusEnergyBase< MeshType, OperatorRightHandSide, Real, Index > BaseType;
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusEnergy< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusEnergyBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class AUSMPlusEnergy< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public AUSMPlusEnergyBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
