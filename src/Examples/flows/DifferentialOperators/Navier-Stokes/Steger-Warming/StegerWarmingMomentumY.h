/***************************************************************************
                          StegerWarmingMomentumY.h  -  description
                             -------------------
    begin                : Feb 18, 2017
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingMomentumY< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   : public StegerWarmingMomentumBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
{
   public:
      ...
      {
         return String( "StegerWarmingMomentumY< " ) +
             MeshType::getType() + ", " +
             TNL::getType< Real >() + ", " +
             TNL::getType< Index >() + " >"; 
      }
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingMomentumY< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
   ...
   public:
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return -hxInverse * ( 
                               ...
                               - this->positiveOtherMomentumFlux( density_west  , velocity_x_west  , velocity_y_west  , pressure_west   )
                               - this->negativeOtherMomentumFlux( density_center, velocity_x_center, velocity_y_center, pressure_center )
                               + this->negativeOtherMomentumFlux( density_east  , velocity_x_east  , velocity_y_east  , pressure_east   )
                             )
                -hyInverse * ( 
...
template< typename MeshReal,
	  ...
	  typename OperatorRightHandSide,
          typename Real,
          typename Index >
class StegerWarmingMomentumY< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, OperatorRightHandSide, Real, Index >
                       ...
                       const RealType& time = 0.0 ) const
      {
         ...
         return -hxInverse * ( 
                ...
                -hzInverse * ( 
                               ...
                               - this->positiveOtherMomentumFlux( density_down  , velocity_z_down  , velocity_y_down  , pressure_down   )
                               - this->negativeOtherMomentumFlux( density_center, velocity_z_center, velocity_y_center, pressure_center )
                               + this->negativeOtherMomentumFlux( density_up    , velocity_z_up    , velocity_y_up    , pressure_up     )
                             )
               +
                 this->rightHandSide(u, entity, time);
      }
