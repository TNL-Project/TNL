...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class VanLeerMomentumZ< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
   : public VanLeerMomentumBase< Meshes::Grid< 1, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:

      typedef Meshes::Grid< 1, MeshReal, Device, MeshIndex > MeshType;
      typedef VanLeerMomentumBase< MeshType, Real, Index > BaseType;
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class VanLeerMomentumZ< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
   : public VanLeerMomentumBase< Meshes::Grid< 2, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
...
template< typename MeshReal,
          ...
          typename Real,
          typename Index >
class VanLeerMomentumZ< Meshes::Grid< 3,MeshReal, Device, MeshIndex >, Real, Index >
   : public VanLeerMomentumBase< Meshes::Grid< 3, MeshReal, Device, MeshIndex >, Real, Index >
{
   public:
