...
public:
    ...
    */
   void
   setDimensions( const Index rows, const Index columns );

   void
   setCompressedRowLengths( CompressedRowLengthsVector& rowLengths )
   {
      rowLengths.setValue( this->getNumberOfMatrixElements() );
   }
   ...
   __cuda_callable__
   void
   setElement( Index row, Index col, Real value );
   ...
   __cuda_callable__
   Real
   getElement( Index row, Index col ) const;
    ...
    */
   void
   getRow( Index row, Index col, Real* mainRow, Index size );
    ...
    */
   void
   getRowGPU( Index row, Index col, Real* mainRow, Index size );
    ...
    */
   void
   setRow( Index row, Index col, Real* mainRow, Index size );
    ...
    */
   void
   setRowGPU( Index row, Index col, Real* mainRow, Index size );
    ...
    */
   void
   setRow( Index row, Index col, Vector& mainRow );
   /**
    * Returns ROW on row and starting column. Can be
    ...
    */
   void
   getRow( Index row, Index col, Vector& mainRow );
   ...
   void
   getData( TNL::Containers::Vector< Real, Device1, Index >& data );
   ...
   __cuda_callable__
   void
   swapRows( Index row1, Index row2, Index column );
   ...
   operator=( Matrix< Real, Device2, Index >& matrix );
