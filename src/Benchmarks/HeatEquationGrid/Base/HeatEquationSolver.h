...
template <typename Real>
TNL::Config::ConfigDescription HeatEquationSolver<Real>::Parameters::makeInputConfig()
{
...
template <typename Real>
HeatEquationSolver<Real>::Parameters::Parameters(const TNL::Config::ParameterContainer &parameters) : xSize(parameters.getParameter<int>("grid-x-size")),
...
template <typename Real>
template <typename Device>
bool HeatEquationSolver<Real>::writeGNUPlot(const std::string &filename,
                                       const HeatEquationSolver<Real>::Parameters &params,
                                       const TNL::Containers::Array<Real, Device> &map) const {
