...
template< typename Real,
          typename Device,
          typename Index >
struct HeatEquationSolverBenchmarkFDMGrid< 1, Real, Device, Index >: public HeatEquationSolverBenchmark< 1, Real, Device, Index >
{
...
template< typename Real,
          typename Device,
          typename Index >
struct HeatEquationSolverBenchmarkFDMGrid< 2, Real, Device, Index >: public HeatEquationSolverBenchmark< 2, Real, Device, Index >
{
...
template< typename Real,
          typename Device,
          typename Index >
struct HeatEquationSolverBenchmarkFDMGrid< 3, Real, Device, Index >: public HeatEquationSolverBenchmark< 3, Real, Device, Index >
{
