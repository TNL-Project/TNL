...
#include "GraphBenchmarkColoring.h"
...
{
   TNL::Benchmarks::Graphs::GraphBenchmarkColoring< Real > benchmark( parameters );
...
main( int argc, char* argv[] )
{
   ...
   configSetup( config );
   TNL::Benchmarks::Graphs::GraphBenchmarkColoring<>::configSetup( config );
