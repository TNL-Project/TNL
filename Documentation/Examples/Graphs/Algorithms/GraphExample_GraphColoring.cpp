...
graphColoringExample()
{
    ...
    */
   VectorType colorsForCheck;
   TNL::Graphs::Algorithms::graphColoring( graph, colorsForCheck );
   bool isProper = TNL::Graphs::Algorithms::isProperlyColored( graph, colorsForCheck );
