...
void
setElement_on_host( const int matrixSize, Matrix& matrix )
{
...
template< typename Matrix >
void
setElement_on_host_and_transfer( const int matrixSize, Matrix& matrix )
{
...
template< typename Matrix >
void
setElement_on_device( const int matrixSize, Matrix& matrix )
{
   matrix.setDimensions( matrixSize, matrixSize );
...
template< typename Matrix >
void
getRow( const int matrixSize, Matrix& matrix )
{
   matrix.setDimensions( matrixSize, matrixSize );
...
template< typename Matrix >
void
forElements( const int matrixSize, Matrix& matrix )
{
   matrix.setDimensions( matrixSize, matrixSize );
